...
func ConvertImports(Source:String) -> String
{
	/*
...
//	export const D;
//	export
func ConvertExports(Source:String) -> String
{
	/*
...
func RewriteES6ImportsAndExports(_ originalScript:String) -> String
{
	var Source = originalScript
	Source = ConvertImports(Source:Source)
	Source = ConvertExports(Source: Source)
	return Source
}
